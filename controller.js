...
module.exports = (function () {
	return {
		get_all_cargo: function (req, res) {
			console.log("getting all cargo from database: ");
			...
			Fabric_Client.newDefaultKeyValueStore({
				...
				// queryAllCargo - requires no arguments , ex: args: [''],
				const request = {
		...
		add_cargo: function (req, res) {
			console.log("submit recording of a cargo catch: ");

			var array = req.params.cargo.split("-");
			console.log(array);
			...
			Fabric_Client.newDefaultKeyValueStore({
				...
				// recordCargo - requires 5 args, ID, vessel, location, timestamp,holder - ex: args: ['10', 'Hound', '-12.021, 28.012', '1504054225', 'Hansel'], 
		...
		get_cargo: function (req, res) {
			...
			Fabric_Client.newDefaultKeyValueStore({
				...
				// queryCargo - requires 1 argument, ex: args: ['4'],
				const request = {
					chaincodeId: 'cargo-app',
					txId: tx_id,
					fcn: 'queryCargo',
		...
		change_holder: function (req, res) {
			console.log("changing holder of cargo catch: ");
		...
		getLoadedContainers: function (req, res) {
			console.log("getting all loaded containers from cargo: ");
			...
			Fabric_Client.newDefaultKeyValueStore({
				...
				// getLoadedContainers - requires no arguments , ex: args: [''],
				const request = {
					chaincodeId: 'cargo-app',
					txId: tx_id,
		...
		getAvilableContainers: function (req, res) {
			console.log("getting all available containers from cargo: ");
			...
			Fabric_Client.newDefaultKeyValueStore({
				...
				// getAvilableContainers - requires no arguments , ex: args: [''],
				const request = {
					chaincodeId: 'cargo-app',
					txId: tx_id,
